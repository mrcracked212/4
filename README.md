...
`settings.json`, `pending_groups.json`. Backup otomatis tersimpan
di `data/backups/` (path bisa diubah lewat `MAINTENANCE.BACKUP_PATH`).
...
### 4.10 `PRIVILEGES` (kekebalan owner/admin)
